...
const FLOWS = [
  ...
  },
  {
    ...
    intro: 'Install from the store, no invite link.',
    items: [
      ...
      { step: 6, label: 'Contacts · system prompt', route: '#/onboarding/contacts' },
      { step: 7, label: 'Contacts · manual add (after Don’t Allow)', route: '#/onboarding/contacts?manual=1' },
      { step: 8, label: 'Interests quiz (optional)', route: '#/onboarding/interests' },
      { step: 9, label: 'Home · new user (cold)', route: '#/?newuser=1&entry=cold' },
    ],
  },
  {
    kind: 'path',
    ...
    items: [
      ...
      { step: 7, label: 'Contacts', route: '#/onboarding/contacts' },
      { step: 8, label: 'Contacts · manual', route: '#/onboarding/contacts?manual=1' },
      { step: 9, label: 'Interests quiz', route: '#/onboarding/interests' },
      { step: 10, label: 'Home · new user (friend context)', route: '#/?newuser=1&entry=friend&label=Eleanor' },
    ],
  },
  {
    kind: 'path',
    ...
    items: [
      ...
      { step: 6, label: 'Your name', route: '#/onboarding/name' },
      { step: 7, label: 'Contacts', route: '#/onboarding/contacts' },
      { step: 8, label: 'Interests quiz', route: '#/onboarding/interests' },
      { step: 9, label: 'Home · new user (circle)', route: `#/?newuser=1&entry=circle&label=${enc('Inner Circle')}` },
      { step: 10, label: 'Circles tab', route: '#/circles' },
    ],
  },
  {
    kind: 'path',
  ...
  },
  {
    ...
    intro: 'Same empty state shell; copy + strip follow session / URL seed.',
    items: [
