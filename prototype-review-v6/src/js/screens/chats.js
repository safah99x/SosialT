...
export function renderChats(container) {
  ...
  function paintList() {
    ...
    visible.forEach((t) => {
      ...
      const subtitle = e ? (e.group || '') : (t.circle || '');
      ...
      const badge = t.unread
        ? `<span class="chats-row__unread" aria-label="${t.unread} unread">${t.unread}</span>`
        : '';
