 ...
 * Five slots: Home, Events, +, Circles, Chats.
...
const ICONS = {
  ...
  events: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/><rect x="14" y="5" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/><rect x="3" y="14" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/><rect x="14" y="14" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/></svg>`,
...
export function createBottomNav({ active = 'home' } = {}) {
  ...
  nav.innerHTML = `
    ...
    <button class="bottom-nav__tab" data-tab="events">
      <span class="bottom-nav__icon">${ICONS.events}</span>
  ...
  nav.querySelector('#bottom-nav-plus').addEventListener('click', () => {
    openCreateSheet();
  });
    ...
    <div class="create-sheet__panel">
      ...
      <button class="create-sheet__option" data-go="quick-ping">
        ...
        <span class="create-sheet__option-body">
          ...
          <span class="create-sheet__option-desc">Now-ish</span>
        </span>
      ...
      <button class="create-sheet__option" data-go="create-event">
        ...
        <span class="create-sheet__option-body">
          ...
          <span class="create-sheet__option-desc">On purpose</span>
        </span>
        <span class="create-sheet__option-arrow">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18L15 12L9 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
        </span>
